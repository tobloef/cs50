...
{
    var latLgn = new google.maps.LatLng(parseFloat(place.latitude), parseFloat(place.longitude));
    ...
    google.maps.event.addListener(marker, "click", function() {
        ...
        .done(function(data, textStatus, jqXHR) {
	        ...
	        $.getJSON("http://api.openweathermap.org/data/2.5/weather", {
	            q: place.place_name + "," + place.admin_code1,
	            APPID: "91a6d5f00a9973e6a56222fc1a195443"
	        })
            .done(function(data, textStatus, jqXHR) {
                var weatherInfo;
                if (data) {
                    ...
                    weatherInfo = "<p><b>Current Weather:</b><br/>" + f + "&degF / " + c + "&degC, " + data.weather[0].description + "</p>";
                } else {
